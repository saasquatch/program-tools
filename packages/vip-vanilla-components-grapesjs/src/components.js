...
export default (editor, config = {}) => {
  ...
  const markdownUi = {
    'ui:widget': (props) => {
      ...
      return (<div className={`checkbox ${disabled || readonly || schema.readonly ? "disabled" : ""}`}>
        <label>
          <input
            type="checkbox"
            id={id}
  ...
  // 
  // 
  const progressBarColorObj = { type: 'string', title: 'Progress Circle Color' }
  const progressTextColorObj = { type: 'string', title: 'Text Color' }
  const progressPresentColorObj = { type: 'string', title: 'Gift Color' }
    ...
    model: textComp.model.extend({
      defaults: Object.assign({}, textComp.model.prototype.defaults, {
        ...
        traits: [
          ...
          { type: 'string', name: 'noprogresspresentcolor' },
          ...
          { type: 'string', name: 'inprogresspresentcolor' },
          ...
          { type: 'string', name: 'completedpresentcolor' },
        ...
        uiSchema: {
          ...
          'completedneededmessage': { 'ui:widget': 'textarea' },
          'completedpresentcolor': { 'ui:widget': 'color' },
          'ismarkdown': markdownUi
              ...
              'oneOf': [
                {
                  'properties': {
                    ...
                    'ismarkdown': { 'type': 'boolean', 'title': 'Use Markdown', 'readonly':true},
                    ...
                    'noprogresspresentcolor': progressPresentColorObj,
                ...
                },
                {
                  'properties': {
                    ...
                    'inprogresspresentcolor': progressPresentColorObj,
                ...
                },
                {
                  'properties': {
                    ...
                    'completedneededmessage': { type: 'string', title: 'Rewarded Text' },
                    'completedprogresscolor': progressBarColorObj,
                    'completedpresentcolor': progressPresentColorObj,
