...
export class SqbConditionalSection {
  /**
   * Show child content when a user meets specified criteria. <a href="http://docs.jsonata.org/overview.html">JSONata expression</a> is used to define this logic. A participant’s segments, country code, custom fields and email can be used.
   * @uiName Condition
   * @uiWidget textArea
   * @required
   * @minLength 1
