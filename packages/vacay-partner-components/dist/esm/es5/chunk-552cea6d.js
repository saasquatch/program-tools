...
var visitor = createCommonjsModule(function (e, t) { Object.defineProperty(t, "__esModule", { value: !0 }), t.visit = function (e, t) { var a = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : r, s = void 0, u = Array.isArray(e), c = [e], l = -1, d = [], f = void 0, p = void 0, h = void 0, v = [], y = [], m = e; do {
    ...
    if (g) {
        if (p = 0 === y.length ? void 0 : v[v.length - 1], f = h, h = y.pop(), b) {
            ...
            for (var k = 0, _ = 0; _ < d.length; _++) {
                var w = d[_][0], O = d[_][1];
                u && (w -= k), u && null === O ? (f.splice(w, 1), k++) : f[w] = O;
            }
        }
...
function writeFieldToStore(e) { var t, r, n = e.field, i = e.value, o = e.dataId, a = e.context, s = a.variables, u = a.dataIdFromObject, c = a.store, l = storeKeyNameFromField(n, s), d = !1, f = ""; if (n.selectionSet && null !== i)
    ...
    t = null != i && "object" == typeof i ? { type: "json", json: i } : i; var I, k = __assign$9({}, c.get(o), ((I = {})[l] = t, I)); d && mergeWithGenerated(f, t.id, c), (r = c.get(o)) && t === r[l] || c.set(o, k); }
...
var lexer = createCommonjsModule(function (e, t) { Object.defineProperty(t, "__esModule", { value: !0 }), t.TokenKind = void 0, t.createLexer = function (e, t) { var r = new D(a, 0, 0, 0, 0, null); return { source: e, options: t, lastToken: r, token: r, line: 1, lineStart: 0, advance: i, lookahead: o }; }, t.getTokenDesc = function (e) { var t = e.value; return t ? e.kind + ' "' + t + '"' : e.kind; }; var r, n = (r = blockStringValue_1) && r.__esModule ? r : { default: r }; function i() { return this.lastToken = this.token, this.token = this.lookahead(); } function o() { var e = this.token; if (e.kind !== s)
    ...
    } while (e.kind === T); return e; } var a = "<SOF>", s = "<EOF>", u = "!", c = "$", l = "(", d = ")", f = "...", p = ":", h = "=", v = "@", y = "[", m = "]", g = "{", b = "|", E = "}", I = "Name", k = "Int", _ = "Float", w = "String", O = "BlockString", T = "Comment"; t.TokenKind = { SOF: a, EOF: s, BANG: u, DOLLAR: c, PAREN_L: l, PAREN_R: d, SPREAD: f, COLON: p, EQUALS: h, AT: v, BRACKET_L: y, BRACKET_R: m, BRACE_L: g, PIPE: b, BRACE_R: E, NAME: I, INT: k, FLOAT: _, STRING: w, BLOCK_STRING: O, COMMENT: T }; var N = String.prototype.charCodeAt, S = String.prototype.slice; function D(e, t, r, n, i, o, a) { this.kind = e, this.start = t, this.end = r, this.line = n, this.column = i, this.value = a, this.prev = o, this.next = null; } function F(e) { return isNaN(e) ? s : e < 127 ? JSON.stringify(String.fromCharCode(e)) : '"\\u' + ("00" + e.toString(16).toUpperCase()).slice(-4) + '"'; } function x(e, t) { var r = e.source, i = r.body, o = i.length, a = function (e, t, r) { for (var n = e.length, i = t; i < n;) {
    var o = N.call(e, i);
    if (9 === o || 32 === o || 44 === o || 65279 === o)
        ...
        if (13 !== o)
            break;
        10 === N.call(e, i + 1) ? i += 2 : ++i, ++r.line, r.lineStart = i;
    }
} return i; }(i, t.end, e), x = e.line, P = 1 + a - e.lineStart; if (a >= o)
    return new D(s, o, o, x, P, t); var q = N.call(i, a); if (q < 32 && 9 !== q && 10 !== q && 13 !== q)
    throw (0, error.syntaxError)(r, a, "Cannot contain the invalid character " + F(q) + "."); switch (q) {
    case 33: return new D(u, a, a + 1, x, P, t);
    case 35: return function (e, t, r, n, i) { var o = e.body, a = void 0, s = t; do {
        a = N.call(o, ++s);
    } while (null !== a && (a > 31 || 9 === a)); return new D(T, t, s, r, n, i, S.call(o, t + 1, s)); }(r, a, x, P, t);
    case 36: return new D(c, a, a + 1, x, P, t);
    case 40: return new D(l, a, a + 1, x, P, t);
    case 41: return new D(d, a, a + 1, x, P, t);
    case 46:
        if (46 === N.call(i, a + 1) && 46 === N.call(i, a + 2))
    ...
    case 120:
    case 121:
    case 122: return function (e, t, r, n, i) { for (var o = e.body, a = o.length, s = t + 1, u = 0; s !== a && null !== (u = N.call(o, s)) && (95 === u || u >= 48 && u <= 57 || u >= 65 && u <= 90 || u >= 97 && u <= 122);)
        ++s; return new D(I, t, s, r, n, i, S.call(o, t, s)); }(r, a, x, P, t);
    case 45:
    case 48:
    case 49:
    case 50:
    ...
    case 55:
    case 56:
    case 57: return function (e, t, r, n, i, o) { var a = e.body, s = r, u = t, c = !1; if (45 === s && (s = N.call(a, ++u)), 48 === s) {
        if ((s = N.call(a, ++u)) >= 48 && s <= 57)
            throw (0, error.syntaxError)(e, u, "Invalid number, unexpected digit after 0: " + F(s) + ".");
    }
    else
        u = R(e, u, s), s = N.call(a, u); return 46 === s && (c = !0, s = N.call(a, ++u), u = R(e, u, s), s = N.call(a, u)), 69 !== s && 101 !== s || (c = !0, 43 !== (s = N.call(a, ++u)) && 45 !== s || (s = N.call(a, ++u)), u = R(e, u, s)), new D(c ? _ : k, t, u, n, i, o, S.call(a, t, u)); }(r, a, q, x, P, t);
    case 34: return 34 === N.call(i, a + 1) && 34 === N.call(i, a + 2) ? function (e, t, r, i, o) { for (var a = e.body, s = t + 3, u = s, c = 0, l = ""; s < a.length && null !== (c = N.call(a, s));) {
        if (34 === c && 34 === N.call(a, s + 1) && 34 === N.call(a, s + 2))
            return l += S.call(a, u, s), new D(O, t, s + 3, r, i, o, (0, n.default)(l));
        if (c < 32 && 9 !== c && 10 !== c && 13 !== c)
            throw (0, error.syntaxError)(e, s, "Invalid character within String: " + F(c) + ".");
        92 === c && 34 === N.call(a, s + 1) && 34 === N.call(a, s + 2) && 34 === N.call(a, s + 3) ? (l += S.call(a, u, s) + '"""', u = s += 4) : ++s;
    } throw (0, error.syntaxError)(e, s, "Unterminated string."); }(r, a, x, P, t) : function (e, t, r, n, i) { for (var o, a, s, u, c = e.body, l = t + 1, d = l, f = 0, p = ""; l < c.length && null !== (f = N.call(c, l)) && 10 !== f && 13 !== f;) {
        if (34 === f)
            return p += S.call(c, d, l), new D(w, t, l + 1, r, n, i, p);
        if (f < 32 && 9 !== f)
            throw (0, error.syntaxError)(e, l, "Invalid character within String: " + F(f) + ".");
        if (++l, 92 === f) {
            switch ((p += S.call(c, d, l - 1), f = N.call(c, l))) {
                case 34:
                    p += '"';
                    break;
                case 47:
                ...
                case 116:
                    ...
                    break;
                case 117:
                    var h = (o = N.call(c, l + 1), a = N.call(c, l + 2), s = N.call(c, l + 3), u = N.call(c, l + 4), A(o) << 12 | A(a) << 8 | A(s) << 4 | A(u));
                    if (h < 0)
...
} throw (0, error.syntaxError)(r, a, function (e) { return 39 === e ? "Unexpected single quote character ('), did you mean to use a double quote (\")?" : "Cannot parse the unexpected character " + F(e) + "."; }(q)); } function R(e, t, r) { var n = e.body, i = t, o = r; if (o >= 48 && o <= 57) {
    do {
        o = N.call(n, ++i);
    } while (o >= 48 && o <= 57);
    return i;
} throw (0, error.syntaxError)(e, i, "Invalid number, expected digit but got: " + F(o) + "."); } function A(e) { return e >= 48 && e <= 57 ? e - 48 : e >= 65 && e <= 70 ? e - 55 : e >= 97 && e <= 102 ? e - 87 : -1; } D.prototype.toJSON = D.prototype.inspect = function () { return { kind: this.kind, value: this.value, line: this.line, column: this.column }; }; });
unwrapExports(lexer);
...
var directiveLocation_1 = directiveLocation.DirectiveLocation, parser = createCommonjsModule(function (e, t) { function r(e) { var t = U(e, lexer.TokenKind.NAME); return { kind: kinds.NAME, value: t.value, loc: Q(e, t) }; } function n(e) { if ($(e, lexer.TokenKind.NAME))
    ...
    r.push(k(e, t)); return r; } function k(e, t) { var n = e.token; return U(e, lexer.TokenKind.AT), { kind: kinds.DIRECTIVE, name: r(e), arguments: f(e, t), loc: Q(e, n) }; } function _(e) { var t = e.token, r = void 0; return V(e, lexer.TokenKind.BRACKET_L) ? (r = _(e), U(e, lexer.TokenKind.BRACKET_R), r = { kind: kinds.LIST_TYPE, type: r, loc: Q(e, t) }) : r = w(e), V(e, lexer.TokenKind.BANG) ? { kind: kinds.NON_NULL_TYPE, type: r, loc: Q(e, t) } : r; } function w(e) { var t = e.token; return { kind: kinds.NAMED_TYPE, name: r(e), loc: Q(e, t) }; } function O(e) { var t = T(e) ? e.lookahead() : e.token; if (t.kind === lexer.TokenKind.NAME)
    switch (t.value) {
        case "schema": return function (e) { var t = e.token; B(e, "schema"); var r = I(e, !0), n = G(e, lexer.TokenKind.BRACE_L, S, lexer.TokenKind.BRACE_R); return { kind: kinds.SCHEMA_DEFINITION, directives: r, operationTypes: n, loc: Q(e, t) }; }(e);
        case "scalar": return function (e) { var t = e.token, n = N(e); B(e, "scalar"); var i = r(e), o = I(e, !0); return { kind: kinds.SCALAR_TYPE_DEFINITION, description: n, name: i, directives: o, loc: Q(e, t) }; }(e);
        case "type": return function (e) { var t = e.token, n = N(e); B(e, "type"); var i = r(e), o = D(e), a = I(e, !0), s = F(e); return { kind: kinds.OBJECT_TYPE_DEFINITION, description: n, name: i, interfaces: o, directives: a, fields: s, loc: Q(e, t) }; }(e);
        case "interface": return function (e) { var t = e.token, n = N(e); B(e, "interface"); var i = r(e), o = I(e, !0), a = F(e); return { kind: kinds.INTERFACE_TYPE_DEFINITION, description: n, name: i, directives: o, fields: a, loc: Q(e, t) }; }(e);
        case "union": return function (e) { var t = e.token, n = N(e); B(e, "union"); var i = r(e), o = I(e, !0), a = P(e); return { kind: kinds.UNION_TYPE_DEFINITION, description: n, name: i, directives: o, types: a, loc: Q(e, t) }; }(e);
        case "enum": return function (e) { var t = e.token, n = N(e); B(e, "enum"); var i = r(e), o = I(e, !0), a = q(e); return { kind: kinds.ENUM_TYPE_DEFINITION, description: n, name: i, directives: o, values: a, loc: Q(e, t) }; }(e);
        case "input": return function (e) { var t = e.token, n = N(e); B(e, "input"); var i = r(e), o = I(e, !0), a = L(e); return { kind: kinds.INPUT_OBJECT_TYPE_DEFINITION, description: n, name: i, directives: o, fields: a, loc: Q(e, t) }; }(e);
        case "extend": return function (e) { var t = e.lookahead(); if (t.kind === lexer.TokenKind.NAME)
            switch (t.value) {
                ...
                case "enum": return function (e) { var t = e.token; B(e, "extend"), B(e, "enum"); var n = r(e), i = I(e, !0), o = q(e); if (0 === i.length && 0 === o.length)
        ...
        case "directive": return function (e) { var t = e.token, n = N(e); B(e, "directive"), U(e, lexer.TokenKind.AT); var i = r(e), o = R(e); B(e, "on"); var a = function (e) { V(e, lexer.TokenKind.PIPE); var t = []; do {
            t.push(M(e));
    ...
    } throw K(e, t); } function T(e) { return $(e, lexer.TokenKind.STRING) || $(e, lexer.TokenKind.BLOCK_STRING); } function N(e) { if (T(e))
    return m(e); } function S(e) { var t = e.token, r = a(e); U(e, lexer.TokenKind.COLON); var n = w(e); return { kind: kinds.OPERATION_TYPE_DEFINITION, operation: r, type: n, loc: Q(e, t) }; } function D(e) { var t = []; if ("implements" === e.token.value) {
    e.advance();
    do {
        t.push(w(e));
    } while ($(e, lexer.TokenKind.NAME));
} return t; } function F(e) { return $(e, lexer.TokenKind.BRACE_L) ? G(e, lexer.TokenKind.BRACE_L, x, lexer.TokenKind.BRACE_R) : []; } function x(e) { var t = e.token, n = N(e), i = r(e), o = R(e); U(e, lexer.TokenKind.COLON); var a = _(e), s = I(e, !0); return { kind: kinds.FIELD_DEFINITION, description: n, name: i, arguments: o, type: a, directives: s, loc: Q(e, t) }; } function R(e) { return $(e, lexer.TokenKind.PAREN_L) ? G(e, lexer.TokenKind.PAREN_L, A, lexer.TokenKind.PAREN_R) : []; } function A(e) { var t = e.token, n = N(e), i = r(e); U(e, lexer.TokenKind.COLON); var o = _(e), a = void 0; V(e, lexer.TokenKind.EQUALS) && (a = g(e)); var s = I(e, !0); return { kind: kinds.INPUT_VALUE_DEFINITION, description: n, name: i, type: o, defaultValue: a, directives: s, loc: Q(e, t) }; } function P(e) { var t = []; if (V(e, lexer.TokenKind.EQUALS)) {
    V(e, lexer.TokenKind.PIPE);
    do {
        t.push(w(e));
    } while (V(e, lexer.TokenKind.PIPE));
} return t; } function q(e) { return $(e, lexer.TokenKind.BRACE_L) ? G(e, lexer.TokenKind.BRACE_L, C, lexer.TokenKind.BRACE_R) : []; } function C(e) { var t = e.token, n = N(e), i = r(e), o = I(e, !0); return { kind: kinds.ENUM_VALUE_DEFINITION, description: n, name: i, directives: o, loc: Q(e, t) }; } function L(e) { return $(e, lexer.TokenKind.BRACE_L) ? G(e, lexer.TokenKind.BRACE_L, A, lexer.TokenKind.BRACE_R) : []; } function M(e) { var t = e.token, n = r(e); if (directiveLocation.DirectiveLocation.hasOwnProperty(n.value))
