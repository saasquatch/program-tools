...
var parser = (function () {
    ...
    function peg$parse(input) {
        var options = arguments.length > 1 ? arguments[1] : {}, peg$FAILED = {}, peg$startRuleFunctions = { start: peg$parsestart }, peg$startRuleFunction = peg$parsestart, peg$c0 = function (elements) {
            return {
            ...
            var string = '', i, j, outerLen, inner, innerLen;
        ...
        }, peg$c3 = /^[^ \t\n\r,.+={}#]/, peg$c4 = { type: "class", value: "[^ \\t\\n\\r,.+={}#]", description: "[^ \\t\\n\\r,.+={}#]" }, peg$c5 = "{", peg$c6 = { type: "literal", value: "{", description: "\"{\"" }, peg$c7 = ",", peg$c8 = { type: "literal", value: ",", description: "\",\"" }, peg$c9 = "}", peg$c10 = { type: "literal", value: "}", description: "\"}\"" }, peg$c11 = function (id, format) {
            return {
        ...
        }, peg$c25 = "select", peg$c26 = { type: "literal", value: "select", description: "\"select\"" }, peg$c27 = function (options) {
            return {
                type: 'selectFormat',
                options: options,
                location: location()
        ...
        }, peg$c31 = "offset:", peg$c32 = { type: "literal", value: "offset:", description: "\"offset:\"" }, peg$c33 = function (number) {
            return number;
...
function MessageFormat(message, locales, formats) {
    ...
    this.format = function (values) {
        try {
            ...
            if (e.variableId) {
                throw new Error('The intl string context variable \'' + e.variableId + '\'' +
...
MessageFormat.prototype._findPluralRuleFunction = function (locale) {
    ...
    throw new Error('Locale data added to IntlMessageFormat is missing a ' +
...
// GENERATED FILE
var defaultLocale = { "locale": "en", "pluralRuleFunction": function (n, ord) { var s = String(n).split("."), v0 = !s[1], t0 = Number(s[0]) == n, n10 = t0 && s[0].slice(-1), n100 = t0 && s[0].slice(-2); if (ord)
        return n10 == 1 && n100 != 11 ? "one" : n10 == 2 && n100 != 12 ? "two" : n10 == 3 && n100 != 13 ? "few" : "other"; return n == 1 && v0 ? "one" : "other"; } };
/* jslint esnext: true */
...
// GENERATED FILE
var defaultLocale$1 = { "locale": "en", "pluralRuleFunction": function (n, ord) { var s = String(n).split("."), v0 = !s[1], t0 = Number(s[0]) == n, n10 = t0 && s[0].slice(-1), n100 = t0 && s[0].slice(-2); if (ord)
...
var FormatJS = {
    format: function (msg, values) {
        var locale = (window.widgetIdent.locale || 'en-US').replace('_', '-');
        var format = new MessageFormat(msg, locale);
        return format.format(values);
    },
    formatRelative: function (value) {
        var locale = (window.widgetIdent.locale || 'en-US').replace('_', '-');
        var relative = new RelativeFormat(locale);
