...
import { a as commonjsGlobal, b as unwrapExports, c as createCommonjsModule, d as process, e as global$1 } from './chunk-7081a6f1.js';
...
const API = {
    ...
    graphql: {
        ...
        getBalanceDetails() {
            const widgetId = widgetIdent();
            if (widgetId["env"] === "demo" || !widgetId) {
                const { rewardBalanceDetails } = demoUser;
                const user = {
                    rewardBalanceDetails
                };
                return Promise.resolve(user);
