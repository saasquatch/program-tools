...
var printer = createCommonjsModule(function (module, exports) {
    ...
    var printDocASTReducer = {
        ...
        ScalarTypeDefinition: function ScalarTypeDefinition(_ref22) {
            var description = _ref22.description, name = _ref22.name, directives = _ref22.directives;
            return join([description, join(['scalar', name, join(directives, ' ')], ' ')], '\n');
        },
        ObjectTypeDefinition: function ObjectTypeDefinition(_ref23) {
            var description = _ref23.description, name = _ref23.name, interfaces = _ref23.interfaces, directives = _ref23.directives, fields = _ref23.fields;
            return join([description, join(['type', name, wrap('implements ', join(interfaces, ', ')), join(directives, ' '), block(fields)], ' ')], '\n');
        },
        FieldDefinition: function FieldDefinition(_ref24) {
            var description = _ref24.description, name = _ref24.name, args = _ref24.arguments, type = _ref24.type, directives = _ref24.directives;
            return join([description, name + wrap('(', join(args, ', '), ')') + ': ' + type + wrap(' ', join(directives, ' '))], '\n');
        },
        InputValueDefinition: function InputValueDefinition(_ref25) {
            var description = _ref25.description, name = _ref25.name, type = _ref25.type, defaultValue = _ref25.defaultValue, directives = _ref25.directives;
            return join([description, join([name + ': ' + type, wrap('= ', defaultValue), join(directives, ' ')], ' ')], '\n');
        },
        InterfaceTypeDefinition: function InterfaceTypeDefinition(_ref26) {
            var description = _ref26.description, name = _ref26.name, directives = _ref26.directives, fields = _ref26.fields;
            return join([description, join(['interface', name, join(directives, ' '), block(fields)], ' ')], '\n');
        },
        UnionTypeDefinition: function UnionTypeDefinition(_ref27) {
            var description = _ref27.description, name = _ref27.name, directives = _ref27.directives, types = _ref27.types;
            return join([description, join(['union', name, join(directives, ' '), types && types.length !== 0 ? '= ' + join(types, ' | ') : ''], ' ')], '\n');
        },
        EnumTypeDefinition: function EnumTypeDefinition(_ref28) {
            var description = _ref28.description, name = _ref28.name, directives = _ref28.directives, values = _ref28.values;
            return join([description, join(['enum', name, join(directives, ' '), block(values)], ' ')], '\n');
        },
        EnumValueDefinition: function EnumValueDefinition(_ref29) {
            var description = _ref29.description, name = _ref29.name, directives = _ref29.directives;
            return join([description, join([name, join(directives, ' ')], ' ')], '\n');
        },
        InputObjectTypeDefinition: function InputObjectTypeDefinition(_ref30) {
            var description = _ref30.description, name = _ref30.name, directives = _ref30.directives, fields = _ref30.fields;
        ...
        DirectiveDefinition: function DirectiveDefinition(_ref37) {
            var description = _ref37.description, name = _ref37.name, args = _ref37.arguments, locations = _ref37.locations;
...
var __assign$c = (undefined && undefined.__assign) || Object.assign || function (t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
        s = arguments[i];
        for (var p in s)
            if (Object.prototype.hasOwnProperty.call(s, p))
...
//@ts-ignore
var squatchJsApi = window.frameElement ? window.frameElement.squatchJsApi : {};
var apolloClient = function () {
    var _e = widgetIdent(), tenantAlias = _e.tenantAlias, appDomain = _e.appDomain, token = _e.token;
    var uri = appDomain + "/api/v1/" + tenantAlias + "/graphql";
    var headers = {
        Authorization: "Bearer " + token
    };
    var client = new ApolloClient({
        link: new HttpLink({ uri: uri, headers: headers }),
...
var API = {
    ...
    analytics: {
        shareEvent: function (shareMedium) {
            var widgetId = widgetIdent();
            if (widgetId["env"] === "demo" || !widgetId)
                return Promise.resolve({});
            var userId = widgetId.userId, accountId = widgetId.accountId, _e = widgetId.programId, programId = _e === void 0 ? "classic" : _e, engagementMedium = widgetId.engagementMedium;
            var variables = {
                eventMeta: {
                    id: userId,
                    accountId: accountId,
            ...
            return apolloClient().mutate({
                mutation: src(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n          mutation ($eventMeta: UserAnalyticsEvent!) {\n            createUserAnalyticsEvent(eventMeta: $eventMeta)\n          }\n        "], ["\n          mutation ($eventMeta: UserAnalyticsEvent!) {\n            createUserAnalyticsEvent(eventMeta: $eventMeta)\n          }\n        "]))),
                variables: variables
            }).then(function (result) {
    ...
    graphql: {
        ...
        getUserFragment: function (userFragment, fragmentVariables) {
            var fragment = src(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n          fragment UserFragment on User {\n            ", "\n          }"], ["\n          fragment UserFragment on User {\n            ", "\n          }"])), userFragment);
            var _e = widgetIdent(), userId = _e.userId, accountId = _e.accountId;
            var variables = Object.assign({}, fragmentVariables, { userId: userId,
                accountId: accountId });
            return this.getClient().query({
                query: src(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n          query($userId: String!, $accountId: String!, $offset: Int) {\n            user(id: $userId, accountId: $accountId) {\n              ...UserFragment\n            }\n          }\n          ", "\n        "], ["\n          query($userId: String!, $accountId: String!, $offset: Int) {\n            user(id: $userId, accountId: $accountId) {\n              ...UserFragment\n            }\n          }\n          ", "\n        "])), fragment),
                variables: variables
            });
        },
        getShareLink: function () {
            ...
            var userId = widgetId.userId, accountId = widgetId.accountId, _e = widgetId.programId, programId = _e === void 0 ? null : _e, engagementMedium = widgetId.engagementMedium;
            var variables = {
                userId: userId,
                accountId: accountId,
                programId: programId,
            ...
            return this.getClient().query({
                ...
                variables: variables
            }).then(function (res) { return res.data.user.shareLink; });
        },
        getReferrals: function (offset, limit) {
            if (offset === void 0) { offset = 0; }
            if (limit === void 0) { limit = 3; }
            var widgetId = widgetIdent();
            if (widgetId["env"] === "demo" || !widgetId) {
                var refs = demoUser.referrals, referredByReferral = demoUser.referredByReferral;
                var referrals = {
                    totalCount: refs.totalCount,
                    data: refs.data.slice(offset, offset + limit)
                };
                var user = { referrals: referrals, referredByReferral: referredByReferral };
                return Promise.resolve(user);
            }
            var userId = widgetId.userId, accountId = widgetId.accountId, _e = widgetId.programId, programId = _e === void 0 ? null : _e;
            var variables = {
                limit: limit,
                offset: offset,
                userId: userId,
        ...
        getStats: function () {
            var widgetId = widgetIdent();
            if (widgetId["env"] === "demo" || !widgetId) {
                var referralsCount = demoUser.referrals, referralsMonth = demoUser.referralsMonth, referralsWeek = demoUser.referralsWeek, rewardsCount = demoUser.rewardsCount, rewardsMonth = demoUser.rewardsMonth, rewardsWeek = demoUser.rewardsWeek, rewardBalances = demoUser.rewardBalances;
                var user = {
        ...
        getBalanceDetails: function () {
            var widgetId = widgetIdent();
            if (widgetId["env"] === "demo" || !widgetId) {
                var rewardBalanceDetails = demoUser.rewardBalanceDetails;
                var user = {
                    rewardBalanceDetails: rewardBalanceDetails
                };
                return Promise.resolve(user);
            }
            var userId = widgetId.userId, accountId = widgetId.accountId, _e = widgetId.programId, programId = _e === void 0 ? null : _e, locale = widgetId.locale;
            var variables = {
                userId: userId,
                accountId: accountId,
                programId: programId,
        ...
        getReferralCode: function () {
            return __awaiter(this, void 0, void 0, function () {
                var widgetId, userId, accountId, programId, variables;
                return __generator(this, function (_e) {
                    widgetId = widgetIdent();
                    if (widgetId["env"] === "demo" || !widgetId)
                        return [2 /*return*/, demoUser.referralcode];
                    userId = widgetId.userId, accountId = widgetId.accountId, programId = widgetId.programId;
                    variables = {
                        userId: userId,
                        accountId: accountId,
                        programId: programId
                    };
                    return [2 /*return*/, this.getClient().query({
                            query: src(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n          query($userId: String!, $accountId: String!, $programId: ID!) {\n            user(id: $userId, accountId: $accountId) {\n              referralCode(programId: $programId)\n            }\n          }\n        "], ["\n          query($userId: String!, $accountId: String!, $programId: ID!) {\n            user(id: $userId, accountId: $accountId) {\n              referralCode(programId: $programId)\n            }\n          }\n        "]))),
                            variables: variables
                        }).then(function (res) { return res.data.user.referralCode; })];
                });
            });
        },
        getFueltankCode: function (rewardKey) {
            return __awaiter(this, void 0, void 0, function () {
                var widgetId, userId, accountId, programId, variables;
                return __generator(this, function (_e) {
                    widgetId = widgetIdent();
                    ...
                    return [2 /*return*/, this.getClient().query({
                            query: src(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n          query($userId: String!, $accountId: String!, $programId: ID!, $rewardKey: String!) {\n            user(id: $userId, accountId: $accountId) {\n              referredByReferral (programId: $programId) {\n                referrerUser {\n                  referralCode (programId: $programId)\n                }\n              }\n              rewards (filter: {\n                programId_eq: $programId\n                programRewardKey_eq: $rewardKey\n              }) {\n                count\n                totalCount\n                data {\n                  fuelTankCode\n                }\n              }\n            }\n          }\n        "], ["\n          query($userId: String!, $accountId: String!, $programId: ID!, $rewardKey: String!) {\n            user(id: $userId, accountId: $accountId) {\n              referredByReferral (programId: $programId) {\n                referrerUser {\n                  referralCode (programId: $programId)\n                }\n              }\n              rewards (filter: {\n                programId_eq: $programId\n                programRewardKey_eq: $rewardKey\n              }) {\n                count\n                totalCount\n                data {\n                  fuelTankCode\n                }\n              }\n            }\n          }\n        "]))),
                            variables: variables
                        }).then(function (res) { return res.data.user; })];
                });
            });
        },
        getMessageLinks: function (mediums) {
            var widgetId = widgetIdent();
            if (widgetId["env"] === "demo" || !widgetId)
            ...
            return this.getClient().query({
                query: src(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n          query($userId: String!, $accountId: String!, $programId: ID, $engagementMedium: UserEngagementMedium!) {\n            user(id: $userId, accountId: $accountId) {\n              ", ":messageLink(programId: $programId, engagementMedium: $engagementMedium, shareMedium: ", ")\n              ", ":messageLink(programId: $programId, engagementMedium: $engagementMedium, shareMedium: ", ")\n              ", ":messageLink(programId: $programId, engagementMedium: $engagementMedium, shareMedium: ", ")\n              ", ":messageLink(programId: $programId, engagementMedium: $engagementMedium, shareMedium: ", ")\n              ", ":messageLink(programId: $programId, engagementMedium: $engagementMedium, shareMedium: ", ")\n              ", ":messageLink(programId: $programId, engagementMedium: $engagementMedium, shareMedium: ", ")\n              ", ":messageLink(programId: $programId, engagementMedium: $engagementMedium, shareMedium: ", ")\n              ", ":messageLink(programId: $programId, engagementMedium: $engagementMedium, shareMedium: ", ")\n              ", ":messageLink(programId: $programId, engagementMedium: $engagementMedium, shareMedium: ", ")\n            }\n          }\n        "], ["\n          query($userId: String!, $accountId: String!, $programId: ID, $engagementMedium: UserEngagementMedium!) {\n            user(id: $userId, accountId: $accountId) {\n              ", ":messageLink(programId: $programId, engagementMedium: $engagementMedium, shareMedium: ", ")\n              ", ":messageLink(programId: $programId, engagementMedium: $engagementMedium, shareMedium: ", ")\n              ", ":messageLink(programId: $programId, engagementMedium: $engagementMedium, shareMedium: ", ")\n              ", ":messageLink(programId: $programId, engagementMedium: $engagementMedium, shareMedium: ", ")\n              ", ":messageLink(programId: $programId, engagementMedium: $engagementMedium, shareMedium: ", ")\n              ", ":messageLink(programId: $programId, engagementMedium: $engagementMedium, shareMedium: ", ")\n              ", ":messageLink(programId: $programId, engagementMedium: $engagementMedium, shareMedium: ", ")\n              ", ":messageLink(programId: $programId, engagementMedium: $engagementMedium, shareMedium: ", ")\n              ", ":messageLink(programId: $programId, engagementMedium: $engagementMedium, shareMedium: ", ")\n            }\n          }\n        "])), mediums[0], mediums[0], mediums[1], mediums[1], mediums[2], mediums[2], mediums[3], mediums[3], mediums[4], mediums[4], mediums[5], mediums[5], mediums[6], mediums[6], mediums[7], mediums[7], mediums[8], mediums[8]),
                variables: variables
            }).then(function (res) { return res.data.user; });
        },
        getUserProgress: function () {
            ...
            var userId = widgetId.userId, accountId = widgetId.accountId, programId = widgetId.programId;
            var variables = {
                userId: userId,
                accountId: accountId,
                programId: programId,
        ...
        getProgramRules: function () {
            ...
            var programId = widgetId.programId;
            var variables = {
                programId: programId
            };
            return this.getClient().query({
                ...
                variables: variables
            }).then(function (res) { return res.data.program; });
        },
    },
    ui: squatchJsApi
};
