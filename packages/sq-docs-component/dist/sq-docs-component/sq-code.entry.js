import { r as registerInstance, h, c as getElement } from './chunk-3f2f9da7.js';
import { c as createCommonjsModule, a as commonjsGlobal } from './chunk-b12caf5b.js';
...
class SqCode {
    ...
    render() {
        return h("pre", { class: `language-${this.syntax}`, hidden: !this.open }, h("code", { class: `language-${this.syntax}` }, h("span", { ref: (el) => this.newElement = el })), h("span", { class: `hidden original` }, this.text));
    }
