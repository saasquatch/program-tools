import { r as registerInstance, h } from './chunk-3f2f9da7.js';
import { c as createCommonjsModule, a as commonjsGlobal, u as unwrapExports } from './chunk-b12caf5b.js';
...
const Clipboard = unwrapExports(clipboard);
...
class SqCodeExample {
    ...
    render() {
        return h("div", null, h("div", { class: "sq-tabs" }, this.tabs.map((tab, i) => {
            const openClass = tab.open ? 'sq-open' : '';
            return (h("div", { class: `sq-tab ${openClass}` }, h("button", { role: "tab", class: `sq-tab-button`, onClick: () => this.openTab(i) }, tab.tabname)));
        })), h("button", { class: "copy-button" }, "Copy"), h("slot", null));
    }
    static get style() { return "sq-code-example .sq-tabs {\n  display: block;\n  margin-bottom: 5px;\n  border-bottom: 1px solid #ddd;\n}\nsq-code-example .sq-tab {\n  display: inline-block;\n  margin-bottom: -1px;\n}\nsq-code-example .sq-tab button:hover {\n  background-color: rgba(200, 200, 200, 0.1);\n  border-radius: 3px 3px 0 0;\n}\nsq-code-example .sq-open button:hover {\n  cursor: default;\n  background-color: #FFF;\n}\nsq-code-example .sq-open button {\n  color: #555;\n  border: 1px solid #ddd;\n  border-radius: 3px 3px 0 0;\n  border-bottom-color: transparent;\n}\nsq-code-example button {\n  background-color: #FFF;\n  border: none;\n  outline: none;\n  cursor: pointer;\n  font-size: 16px;\n  color: #08c;\n  height: 100%;\n  width: 100%;\n  padding: 5px 10px;\n}"; }
}

export { SqCodeExample as sq_code_example };
