  ...
  template: {
    ...
    emails: [
      {
        ...
        description:
          'We send this email when a user has been referred and rewarded.',
        defaults: {
          meta: {
    ...
    rulesUISchema: {
      ...
      referrerRewardRules: {
        ...
        refundWindow: {
          'ui:help':
            'Refund detection does not apply to Fuel Tank or Gift Card rewards.',
          'ui:widget': 'Duration',
          'ui:options': {
            doNotUseToggle: true,
          },
    ...
    logo:
      '//images.ctfassets.net/1th1ybv0b2n4/VWhgIAgzmuEaEGuMe8kKS/41491ce222b05210db916a7a74c3f6e3/rs-program-icon-lifetime-spend.png',
    globallyInstallable: true,
    installableByTenants: ['test_aaxiqyu2cdlrf'],
    schedule: null,
    schedules: null,
    sharing: {
      enabled: true,
      linksConfig: {
        defaults: {
          messages: [
            {
              config: {
                twitterShareBody:
                  'YouÆve been sent a reward to use on your first {companyName} purchase. Click the link to claim! {shareLink}',
              },
              shareMedium: 'TWITTER',
            },
            {
            ...
            },
            {
              config: {
                ...
                pinterestShareBody:
                  'Enjoy this reward to use on your first {companyName} purchase. Click the link to claim! {shareLink}',
              },
          ...
          shareLinkOpenGraph: {
            ...
            source: 'HOSTED',
            description:
              'YouÆve been sent a reward, redeemable on your next purchase with {companyName}. Enjoy! ',
          },
          messageLinkOpenGraph: {
            title: 'YouÆve received a {referredReward} from {companyName}',
            source: 'LANDING_PAGE',
            description:
              'YouÆve been sent a {referredReward} reward, redeemable on your next purchase with {companyName}. Enjoy!   [CTA Button: ôClaim your {referredReward} Reward!]',
          },
        },
      },
    },
