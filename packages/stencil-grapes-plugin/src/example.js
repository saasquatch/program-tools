...
export default (editor, config = {}) => {
  ...
  const fontFamilyOpts = {
    default: 'Roboto',
    enum: ['Roboto', 'Artifakt Element', 'Helvetica Neue,Helvetica,Arial,sans-serif', 'Lato,sans-serif', 'Times New Roman', 'Arial', 'Courier', 'Tahoma', 'Verdana', 'Georgia'],
    enumNames: ['Roboto', 'Artifakt Element', 'Helvetica Neue', 'Lato', 'Times New Roman', 'Arial', 'Courier', 'Tahoma', 'Verdana', 'Georgia'],
  };
  ...
  const poweredByUi = editor.editor.attributes.canWhitelabel
    ...
    : {
        ...
        'ui:help': (
          <div>
            Can only be disabled on <span className="label">Pro</span> plans
          </div>
        ),
        'ui:title': (
          <span>
            <span className="ico ico-lock"></span> Show Powered By
          </span>
        ),
      };
  ...
  const displayOpts = {
    enum: ['mobile-and-desktop', 'mobile-only', 'desktop-only', 'hidden'],
    enumNames: ['Mobile and Desktop', 'Mobile Only', 'Desktop Only', 'Hide'],
  };

  const mobileOnlyDisplayOpts = {
    enum: ['mobile-only', 'hidden'],
    enumNames: ['Mobile Only', 'Hide'],
  };
          ...
          schema: {
            ...
            properties: {
              ...
              referraltype: {
                ...
                enumNames: [
                  'Global Referral List Options',
                  'Converted Rewards (eg Remus)',
                  'Pending Rewards (eg Gellert)',
                  'Referrer (eg Rubeus)',
                  'Expired Rewards',
                  'Cancelled Rewards (Lavender)',
                ],
              },
            },
            dependencies: {
  ...
  const partnerStatsDropdown = {
    ...
    enumNames: ['Pending Balance CAD', 'Available Balance CAD', 'Redeemed Balance CAD', 'Pending Balance USD', 'Available Balance USD', 'Redeemed Balance USD'],
  };
