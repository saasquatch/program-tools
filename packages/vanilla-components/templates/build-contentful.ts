...
const done = ["default-referred-widget-contentful", "default-referrer-widget-contentful", "partner-referrer-widget-contentful", "vip-referrer-widget-contentful"].forEach(filename => {
  // @ts-ignore
