...
export namespace Components {
  ...
  interface SqhCloseButtonAttributes extends StencilHTMLAttributes {
    'text'?: string;
  }
  ...
  interface SqhCopyButtonAttributes extends StencilHTMLAttributes {
    'backgroundcolor'?: string;
    'borderradius'?: number;
    'codefontcolor'?: string;
    'codefontsize'?: number;
  ...
  interface SqhCopyLinkButtonAttributes extends StencilHTMLAttributes {
    'buttoncolor'?: string;
    'copyfailure'?: string;
    'copysuccess'?: string;
    'ishidden'?: boolean;
  ...
  interface SqhGlobalContainerAttributes extends StencilHTMLAttributes {
    'background'?: string;
    'fontfamily'?: string;
    'loadingcolor'?: string;
    'maxwidth'?: string;
  ...
  interface SqhImageComponentAttributes extends StencilHTMLAttributes {
    'alignment'?: string;
    'borderradius'?: number;
    'css'?: string;
    'ishidden'?: boolean;
  ...
  interface SqhPartnerStatComponentAttributes extends StencilHTMLAttributes {
    'ishidden'?: boolean;
  ...
  interface SqhReferralCodeAttributes extends StencilHTMLAttributes {}
  ...
  interface SqhReferralComponentAttributes extends StencilHTMLAttributes {
    'referral'?: Referral | ReferredByReferral;
    'referraltype'?: "converted" | "pending" | "referrer";
    'referralvariables'?: ReferralVariables;
    'unknownuser'?: String;
  ...
  interface SqhReferralListAttributes extends StencilHTMLAttributes {
    'cancelledcolor'?: string;
    'cancelledcontent'?: string;
    'cancelledvalue'?: string;
    'convertedcontent'?: string;
  ...
  interface SqhRewardsActionsAttributes extends StencilHTMLAttributes {
    'hidetext'?: string;
    'nexttext'?: string;
    'previoustext'?: string;
  }
  ...
  interface SqhShareButtonContainerAttributes extends StencilHTMLAttributes {
    'emailbackgroundcolor'?: string;
    'emailclassName'?: string;
    'emaildisplayrule'?: string;
    'emailicon'?: string;
  ...
  interface SqhShareButtonAttributes extends StencilHTMLAttributes {
    'backgroundcolor'?: string;
    'className'?: string;
    'displayrule'?: string;
    'icon'?: string;
  ...
  interface SqhStatComponentAttributes extends StencilHTMLAttributes {
    'ishidden'?: boolean;
    'onStatAdded'?: (event: CustomEvent) => void;
    'onStatTypeUpdated'?: (event: CustomEvent) => void;
    'statcolor'?: string;
  ...
  interface SqhStatsContainerAttributes extends StencilHTMLAttributes {
    'ishidden'?: boolean;
    'paddingbottom'?: string;
    'paddingtop'?: string;
  }
  ...
  interface SqhTextComponentAttributes extends StencilHTMLAttributes {
    'background'?: string;
    'color'?: string;
    'fontfamily'?: string;
    'fontsize'?: string;
...
declare global {
  interface StencilElementInterfaces {
    'SqhCloseButton': Components.SqhCloseButton;
    'SqhCopyButton': Components.SqhCopyButton;
    'SqhCopyLinkButton': Components.SqhCopyLinkButton;
    'SqhGlobalContainer': Components.SqhGlobalContainer;
    'SqhImageComponent': Components.SqhImageComponent;
    'SqhPartnerStatComponent': Components.SqhPartnerStatComponent;
    'SqhReferralCode': Components.SqhReferralCode;
    'SqhReferralComponent': Components.SqhReferralComponent;
    'SqhReferralList': Components.SqhReferralList;
    'SqhRewardsActions': Components.SqhRewardsActions;
    'SqhShareButtonContainer': Components.SqhShareButtonContainer;
    'SqhShareButton': Components.SqhShareButton;
    'SqhStatComponent': Components.SqhStatComponent;
    'SqhStatsContainer': Components.SqhStatsContainer;
    'SqhTextComponent': Components.SqhTextComponent;
  }

  interface StencilIntrinsicElements {
    'sqh-close-button': Components.SqhCloseButtonAttributes;
    'sqh-copy-button': Components.SqhCopyButtonAttributes;
    'sqh-copy-link-button': Components.SqhCopyLinkButtonAttributes;
    'sqh-global-container': Components.SqhGlobalContainerAttributes;
    'sqh-image-component': Components.SqhImageComponentAttributes;
    'sqh-partner-stat-component': Components.SqhPartnerStatComponentAttributes;
    'sqh-referral-code': Components.SqhReferralCodeAttributes;
    'sqh-referral-component': Components.SqhReferralComponentAttributes;
    'sqh-referral-list': Components.SqhReferralListAttributes;
    'sqh-rewards-actions': Components.SqhRewardsActionsAttributes;
    'sqh-share-button-container': Components.SqhShareButtonContainerAttributes;
    'sqh-share-button': Components.SqhShareButtonAttributes;
    'sqh-stat-component': Components.SqhStatComponentAttributes;
    'sqh-stats-container': Components.SqhStatsContainerAttributes;
    'sqh-text-component': Components.SqhTextComponentAttributes;
  }
