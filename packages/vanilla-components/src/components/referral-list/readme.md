...
| `valuecontent`         | `valuecontent`         | ICU message shown in the rewards column. See {@link https://unicode-org.github.io/icu/userguide/format_parse/messages/ ICU messages} for more details. | `string`  | `undefined` |
