...
const demoUser = {
  ...
  referrals: {
    totalCount: 8,
    data: [
      { dateReferralStarted: today.setDate(today.getDate()-2), referredUser: { firstName: "Remus", lastName: "Lupin" }, rewards: 
        [
          { prettyValue: "$20.00", dateExpires: today.setDate(today.getDate()-2), statuses:["EXPIRED"] },
          { prettyValue: "$10.00", statuses:["CANCELLED"] },
          { prettyValue: "$5.00", statuses: ["ACTIVE"] },] },
      { dateReferralStarted: today.setDate(today.getDate()-1), referredUser: { firstName: "Gellert", lastName: "Grindelwald" }, rewards: [{ prettyValue: "$20.00", dateExpires: today.setDate(today.getDate()-2), statuses:["CANCELLED"] }] },
      ...
      { dateReferralStarted: today.setDate(today.getDate()-4), referredUser: { firstName: "Blaise", lastName: "Zabini" }, rewards: [{ prettyValue: "$20.00", statuses: ["ACTIVE"] },{ prettyValue: "$10.00", statuses: ["ACTIVE"] },] },
      { dateReferralStarted: today.setDate(today.getDate()-10), referredUser: { firstName: "Argus", lastName: "Filch" }, rewards: [{statuses: ["CANCELLED"]}] },
      { dateReferralStarted: today.setDate(today.getDate()-15), referredUser: { firstName: "Ron", lastName: "Weasley" }, rewards: [{ prettyValue: "$20.00", statuses: ["ACTIVE"] }] },
      { dateReferralStarted: today.setDate(today.getDate()-2), referredUser: { firstName: "Hermione", lastName: "Granger" }, rewards: [{ prettyValue: "$20.00", statuses: ["ACTIVE"] },{ prettyValue: "$10.00", statuses: ["ACTIVE"] },{ prettyValue: "$5.00", statuses: ["ACTIVE"] },{ prettyValue: "5%", statuses: ["ACTIVE"] },{ prettyValue: "5%", statuses: ["ACTIVE"] },{ prettyValue: "5%", statuses: ["ACTIVE"] },] },
      { dateReferralStarted: today.setDate(today.getDate()-15), referredUser: { firstName: "Harry", lastName: "Potter" }, rewards: [{ prettyValue: "$20.00", statuses: ["ACTIVE"] }] },
    ]
  },
  referredByReferral: { dateReferralStarted: today.setDate(today.getDate()-2), referrerUser: { firstName: "Rubeus", lastName: "Hagrid" , referralCode: 'RUBEUSHAGRID12'}, rewards: [{ fuelTankCode: 'CODE1234', prettyValue: "$10.00", statuses: ["ACTIVE"] }] },
