...
const demoUser = {
  ...
  rewardBalances: [
    ...
    { type: "CREDIT", unit: "USD", value: 10000, prettyValue: "$100.00", totalAssignedCash: "10000", totalAvailableCash: "1000", totalPendingCash: "2000", prettyTotalAssignedCash: "$100.00", prettyTotalAvailableCash: "$10.00", prettyTotalPendingCash: "$20.00" }
  ],
}
