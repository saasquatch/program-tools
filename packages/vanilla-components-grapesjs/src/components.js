    ...
    model: textComp.model.extend({
      defaults: Object.assign({}, textComp.model.prototype.defaults, {
        ...
        traits: [
          ...
          { type: 'string', title: 'Table Background Color', name: 'tablebackgroundcolor'},
          { type: 'string', title: 'Border Color', name: 'bordercolor' },
          { type: 'number', title: 'Border Width', name: 'borderwidth' },
          { type: 'number', title: 'Heading Text Size', name: 'headertextsize' },
          { type: 'string', title: 'Heading Text Color', name: 'headertextcolor' },
          { type: 'string', title: 'Currency Text', name: 'currencytext' },
          { type: 'string', title: 'Currency Text Color', name: 'currencytextcolor' },
          { type: 'string', title: 'Available Text', name: 'availabletext' },
          { type: 'string', title: 'Available Text Color', name: 'availabletextcolor' },
          { type: 'string', title: 'Earned Text', name: 'earnedtext' },
          { type: 'string', title: 'Earned Text Color', name: 'earnedtextcolor' },
          { type: 'string', title: 'Claimed Text', name: 'redeemedtext' },
          { type: 'string', title: 'Claimed Text Color', name: 'redeemedtextcolor' },
          { type: 'number', title: 'Text Size', name: 'textsize' },
          { type: 'string', title: 'Text Color', name: 'textcolor' },
          { type: 'string', title: 'Font Family', name: 'fontfamily' },
          { type: 'number', title: 'Cell Padding', name: 'cellpadding' },
          { type: 'number', title: 'Header Padding', name: 'headerpadding' },
          { type: 'boolean', title: 'Show Country Flag', name: 'showflag' },
          { type: 'number', title: 'Country Flag Width', name: 'flagwidth' },
          { type: 'boolean', title: 'Show Available Balance', name: 'showavailable' },
          { type: 'boolean', title: 'Show Earned Balance', name: 'showearned' },
          { type: 'boolean', title: 'Show Claimed Balance', name: 'showclaimed' },

        ],
        uiSchema: {
          'bordercolor': { 'ui:widget': 'color' },
          'borderwidth': { 'ui:widget': 'updown' },
          'currencytextcolor': { 'ui:widget': 'color' },
          'availabletextcolor': { 'ui:widget': 'color' },
          'earnedtextcolor': { 'ui:widget': 'color' },
          'redeemedtextcolor': { 'ui:widget': 'color' },
          'tablebackgroundcolor': { 'ui:widget': 'color' },
          'text': { 'ui:widget': 'textarea' },
          'ishidden': { 'ui:widget': 'hidden' },
          'color': { 'ui:widget': 'color' },
