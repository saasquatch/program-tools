  ...
  comps.addType('sqh-global-container', {
    ...
    model: defaultModel.extend({
      ...
      defaults: Object.assign({}, defaultModel.prototype.defaults, {
        ...
        draggable: false,
        traits: [
          {type: 'string', title: 'Background Color', name: 'background', value: ''},
  ...
  comps.addType('sqh-text-component', {
    ...
    model: defaultModel.extend({
      ...
      defaults: Object.assign({}, defaultModel.prototype.defaults, {
        ...
        traits: [
          { type: 'boolean', title: 'Hidden', name: 'ishidden', value: '' },
          { type: 'boolean', title: 'Use Markdown', name: 'ismarkdown', value: '' },
          { type: 'string', title: 'Content', name: 'text', value: '' },
          { type: 'string', title: 'Font Color', name: 'color', value: '' },
          { type: 'integer', title: 'Font Size', name: 'fontsize', value: '' },
          { type: 'string', title: 'Text Align', name: 'textalign', enum: ['left', 'center', 'right'], enumNames: ['Left', 'Center', 'Right'], default: '' },
          { type: 'string', title: 'Padding Top', name: 'paddingtop', default: ''},
          { type: 'string', title: 'Padding Bottom', name: 'paddingbottom', default: ''},
    ...
    model: textComp.model.extend({
      defaults: Object.assign({}, textComp.model.prototype.defaults, {
        ...
        traits: [
          ...
          { type: 'string', title: 'Content', name: 'text', value: '' },
          { type: 'string', title: 'Font Color', name: 'color', value: '' },
          { type: 'integer', title: 'Font Size in pixels', name: 'fontsize', value: '' },
          { type: 'string', title: 'Text Align', name: 'textalign', enum: ['left', 'center', 'right'], enumNames: ['Left', 'Center', 'Right'], default: '' },
          { type: 'string', title: 'Padding Top in pixels', name: 'paddingtop', default: ''},
          { type: 'string', title: 'Padding Bottom in pixels', name: 'paddingbottom', default: ''},
        ],
        uiSchema: {
          'ishidden': { 'ui:widget': 'hidden' },
  ...
  comps.addType('sqh-body', {
    model: textComp.model.extend({
      defaults: Object.assign({}, textComp.model.prototype.defaults, {
        name: 'Body',
        traits: [
          { type: 'boolean', title: 'Hidden', name: 'ishidden' },
  ...
  comps.addType('sqh-banner', {
    model: textComp.model.extend({
      defaults: Object.assign({}, textComp.model.prototype.defaults, {
        ...
        traits: [
          { type: 'boolean', title: 'Hidden', name: 'ishidden', value: '' },
          { type: 'string', title: 'Upload Image', name: 'background', value: '' /*,format: 'uri'*/ },
          { type: 'string', title: 'Height in pixels', name: 'height', value: '' },
          { type: 'string', title: 'Padding Top in pixels', name: 'paddingtop', default: ''},
          { type: 'string', title: 'Padding Bottom in pixels', name: 'paddingbottom', default: ''},
          { type: 'string', title: 'Content', name: 'text', value: '' },
          { type: 'string', title: 'Font Color in pixels', name: 'color', value: '' },
        ],
        uiSchema: {
          'ishidden': { 'ui:widget': 'hidden' },
          'color': { 'ui:widget': 'color' },
    ...
    model: defaultModel.extend({
        defaults: Object.assign({}, defaultModel.prototype.defaults, {
          ...
          traits: [
            ...
            { type: 'string', title: 'Button Color', name: 'buttoncolor', value: '' },
            { type: 'string', title: 'Text Color', name: 'textcolor', value: '' },
          ],
          uiSchema: {
            'ishidden': { 'ui:widget': 'hidden' },
    ...
    model: defaultModel.extend({
        defaults: Object.assign({}, defaultModel.prototype.defaults, {
          ...
          traits: [
            ...
            { type: 'string', name: 'emaildisplayrule', value: '' },
            { type: 'string', name: 'emailtext', value: '' },
            { type: 'string', name: 'emailtextcolor', value: '' },
            { type: 'string', name: 'emailbackgroundcolor', value: '' },
            { type: 'string', name: 'facebookdisplayrule', value: '' },
            { type: 'string', name: 'facebooktext', value: '' },
            { type: 'string', name: 'facebooktextcolor', value: '' },
            { type: 'string', name: 'facebookbackgroundcolor', value: '' },
            { type: 'string', name: 'twitterdisplayrule', value: '' },
            { type: 'string', name: 'twittertext', value: '' },
            { type: 'string', name: 'twittertextcolor', value: '' },
            { type: 'string', name: 'twitterbackgroundcolor', value: '' },
            { type: 'string', name: 'smsdisplayrule', value: '' },
            { type: 'string', name: 'smstext', value: '' },
            { type: 'string', name: 'smstextcolor', value: '' },
            { type: 'string', name: 'smsbackgroundcolor', value: '' },
            { type: 'string', name: 'whatsappdisplayrule', value: '' },
            { type: 'string', name: 'whatsapptext', value: '' },
            { type: 'string', name: 'whatsapptextcolor', value: '' },
            { type: 'string', name: 'whatsappbackgroundcolor', value: '' },
            { type: 'string', name: 'linkedindisplayrule', value: '' },
            { type: 'string', name: 'linkedintext', value: '' },
            { type: 'string', name: 'linkedintextcolor', value: '' },
            { type: 'string', name: 'linkedinbackgroundcolor', value: '' },
            { type: 'string', name: 'pinterestdisplayrule', value: '' },
            { type: 'string', name: 'pinteresttext', value: '' },
            { type: 'string', name: 'pinteresttextcolor', value: '' },
            { type: 'string', name: 'pinterestbackgroundcolor', value: '' },
            { type: 'string', name: 'messengerdisplayrule', value: '' },
            { type: 'string', name: 'messengertext', value: '' },
            { type: 'string', name: 'messengertextcolor', value: '' },
            { type: 'string', name: 'messengerbackgroundcolor', value: '' },
            { type: 'string', name: 'linedisplayrule', value: '' },
            { type: 'string', name: 'linetext', value: '' },
            { type: 'string', name: 'linetextcolor', value: '' },
            { type: 'string', name: 'linebackgroundcolor', value: '' },
          ],
          uiSchema: {
            ishidden: { 'ui:widget': 'hidden' },
  ...
  comps.addType('sqh-referral-list', {
    model: defaultModel.extend({
      defaults: Object.assign({}, defaultModel.prototype.defaults, {
        ...
        traits: [
          { type: 'boolean', name: 'ishidden', value: '' },
          { type: 'boolean', name: 'showreferrer', value: '' },
          { type: 'boolean', name: 'usefirstreward', value: '' },
          { type: 'string', name: 'rewardcolor', value: "" },
          { type: 'string', name: 'pendingcolor', value: "" },
          { type: 'string', name: 'referralnamecolor', value: '' },
          { type: 'string', name: 'referraltextcolor', value: ''},
          { type: 'string', name: 'pendingvalue', value: "" },
          { type: 'string', name: 'referrervalue', value: "" },
          { type: 'string', name: 'referrercontent', value: "" },
          { type: 'string', name: 'convertedcontent', value: "" },
          { type: 'string', name: 'pendingcontent', value: "" },
          { type: 'string', name: 'valuecontent', value: "" },
          { type: 'string', name: 'paginatemore', value: "" },
          { type: 'string', name: 'paginateless', value: "" },
        ],
        uiSchema: {
  ...
  comps.addType('sqh-image-component', {
    model: defaultModel.extend({
      defaults: Object.assign({}, defaultModel.prototype.defaults, {
        ...
        traits: [
          { type: 'boolean', name: 'ishidden', value: '' },
          { type: 'string', title: 'Upload Image', name: 'url', value: '' /*,format: 'uri'*/ },
          { type: 'string', title: 'Image Align', name: 'alignment', enum: ['left', 'center', 'right'], enumNames: ['Left', 'Center', 'Right'], default: '' },
          { type: 'string', title: 'Size in pixels', name: 'width', value: '' },
        ],
        uiSchema: {
          'ishidden': { 'ui:widget': 'hidden' },
