            ...
            <form className="js-search-form form-search" action="/search/">
              <SearchContainerDiv>
                <InputView
                  ...
                  onChange={(e: any) => props.useSearch.setQuery(e.target.value)}
                />
                <RadioContainerDiv>
                  <RadioView
                    css=""
                  ...
                  <RadioView
                    ...
                    customLabelCSS="margin-left: 0px; margin-right: 35px;"
                    label="Developer"
                    value={props.useSearch.cat === "developerCenter" ? true : false}
                  ...
                  <RadioView
                    ...
                    customLabelCSS="margin-left: 0px; margin-right: 35px;"
                    label="Success"
                    value={props.useSearch.cat === "successCenter" ? true : false}
                    onChange={() => props.useSearch.setCat("successCenter")}
                  />
                  <RadioView
                    css=""
                    label="Designer"
                    value={props.useSearch.cat === "designerCenter" ? true : false}
