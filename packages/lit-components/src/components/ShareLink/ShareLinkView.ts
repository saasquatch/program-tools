...
const getDynamicStyles = (props: ShareLinkProps) => `
  .container-div {
...
export function ShareLinkView(props: ShareLinkProps & ReturnType<typeof useShareLink>) {
    ...
    ${UI.Tooltip({
      ...
      children: buttonStyle === 'icon'
        ...
        : UI.Button({
            ...
            children: props.copyButtonLabel || 'Copy Link',
          }),
    })}
  `;
