...
| `rewardPayoutInProgressText` | `reward-payout-in-progress-text` | Displayed below the status pill when a reward is being paid out.                | `string` | `"Payout process started on"`                                                                                                                                                                                                                                                                                                                              |
