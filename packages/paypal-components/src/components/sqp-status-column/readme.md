...
| ---------------------------- | -------------------------------- | ------------------------------------------------------------------------------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `columnTitle`                | `column-title`                   |                                                                                 | `string` | `"PayPal Status"`                                                                                                                                                                                                                                                                                                                          |
...
| `rewardReturnedText`         | `reward-returned-text`           | Displayed below the status pill when a reward was returned after payout.        | `string` | `"The email you provided does not link to an exisiting PayPalaccount. Payout expired on"`                                                                                                                                                                                                                                                  |
