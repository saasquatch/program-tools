 ...
 * @example Reward Table Date Column - <sqp-rewards-table-date-column column-title="Date received" date-shown="dateGiven"></sqp-rewards-table-date-column>
 */
@Component({
  tag: "sqp-rewards-table-date-column",
  shadow: true,
})
