...
| `rewardPaidOutText`          | `reward-paid-out-text`           | Shown in the dropdown details when a reward has been received.’               | `string`  | `"Sent via PayPal on"`                                                                                                                                                                                                                   |
| `rewardPayoutFailedText`     | `reward-payout-failed-text`      | Shown in the dropdown details when a reward has been received.’               | `string`  | `"Payout last attempted on"`                                                                                                                                                                                                             |
| `rewardPayoutInProgressText` | `reward-payout-in-progress-text` | Shown in the dropdown details when a reward has been received.’               | `string`  | `"PayPal payout processing started on"`                                                                                                                                                                                                  |
