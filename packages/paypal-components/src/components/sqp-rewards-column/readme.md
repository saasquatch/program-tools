...
| `rewardReturnedText`         | `reward-returned-text`           | Shown in the dropdown details when a reward was returned after payout.        | `string`  | `"The email you provided does not link to an exisitingPayPalaccount. Payout expired on {date}."`                                                                                                                                                                                                                                           |
...
| `rewardUnclaimedText`        | `reward-unclaimed-text`          | Shown in the dropdown details when a reward was paid out but is unclaimed.    | `string`  | `"The email you provided does not link to an exisitingPayPalaccount. Payout expires on {date}."`                                                                                                                                                                                                                                           |
