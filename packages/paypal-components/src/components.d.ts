...
declare global {
  ...
  interface HTMLSqpAccountDetailsElement
    extends Components.SqpAccountDetails,
      HTMLStencilElement {}
  var HTMLSqpAccountDetailsElement: {
    prototype: HTMLSqpAccountDetailsElement;
    new (): HTMLSqpAccountDetailsElement;
  };
  interface HTMLSqpGraphqlClientProviderElement
    extends Components.SqpGraphqlClientProvider,
      HTMLStencilElement {}
...
declare module "@stencil/core" {
  export namespace JSX {
    interface IntrinsicElements {
      ...
      "sqp-account-details": LocalJSX.SqpAccountDetails &
        JSXBase.HTMLAttributes<HTMLSqpAccountDetailsElement>;
      "sqp-graphql-client-provider": LocalJSX.SqpGraphqlClientProvider &
        JSXBase.HTMLAttributes<HTMLSqpGraphqlClientProviderElement>;
      "sqp-hook-story-container": LocalJSX.SqpHookStoryContainer &
        JSXBase.HTMLAttributes<HTMLSqpHookStoryContainerElement>;
      "sqp-paypal-details": LocalJSX.SqpPaypalDetails &
        JSXBase.HTMLAttributes<HTMLSqpPaypalDetailsElement>;
      "sqp-rewards-cell": LocalJSX.SqpRewardsCell &
        JSXBase.HTMLAttributes<HTMLSqpRewardsCellElement>;
      "sqp-rewards-column": LocalJSX.SqpRewardsColumn &
        JSXBase.HTMLAttributes<HTMLSqpRewardsColumnElement>;
      "sqp-status-cell": LocalJSX.SqpStatusCell &
        JSXBase.HTMLAttributes<HTMLSqpStatusCellElement>;
      "sqp-status-column": LocalJSX.SqpStatusColumn &
        JSXBase.HTMLAttributes<HTMLSqpStatusColumnElement>;
      "sqp-stencilbook": LocalJSX.SqpStencilbook &
        JSXBase.HTMLAttributes<HTMLSqpStencilbookElement>;
    }
  }
}
