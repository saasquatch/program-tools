...
var parse = function parse(cssText) {
  ...
  for (var i = 0; i < split.length; i++) {
    ...
    if (colonIndex === -1) {
      "development" !== "production" ? warning(false, "[JSS] Malformed CSS string \"" + decl + "\"") : void 0;
      continue;
    }
...
function mergeExtend(style, rule, sheet, newStyle) {
  ...
  if (extendType === 'string') {
    ...
    if (refRule === rule) {
      "development" !== "production" ? warning(false, "[JSS] A rule tries to extend itself \n" + rule.toString()) : void 0;
      return;
    }
...
function registerClass(rule, className) {
  ...
  if (className[0] === '$') {
    ...
    if (!refRule) {
      "development" !== "production" ? warning(false, "[JSS] Referenced rule is not defined. \n" + rule.toString()) : void 0;
      return false;
    }

    if (refRule === rule) {
      "development" !== "production" ? warning(false, "[JSS] Cyclic composition detected. \n" + rule.toString()) : void 0;
      return false;
    }
...
const jss = create$1(create());
const createStyleSheet = (...args) => jss.createStyleSheet(...args);

export { createStyleSheet as c };
