...
| `iconName`        | `icon-name`        | Full list of valid icon names available in the {@link https://shoelace.style/components/icon Shoelace Icon Library}. This value is case sensitive. | `string`                                                                              | `undefined` |
