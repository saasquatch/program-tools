...
| `buttonStyle`     | `button-style`      |                                                                                                                                                            | `"primary" \| "secondary"` | `"primary"`                                                                                                                 |
...
| `finite`          | `finite`            | The number of times a task can be completed when repeatable.  Use zero for no limit (the default).                                                         | `number`                   | `0`                                                                                                                         |
...
| `programId`       | `program-id`        | The ID of the program that is used to scope the task card. When no ID is specified, it defaults to the program context in which the component is rendered. | `string`                   | `undefined`                                                                                                                 |
