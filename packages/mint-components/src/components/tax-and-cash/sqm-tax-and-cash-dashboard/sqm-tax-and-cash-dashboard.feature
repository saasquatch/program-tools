...
Feature: Tax And Cash Dashboard
  ...
  Scenario Outline: Alert displays when a user has gone over the tax limit and we require one to pay them out on the "" tax setting
    ...
    And it has description  "You have surpassed the $2000 threshold for a W9 tax form. To remove the hold, you need to submit a W9 tax form as outlined in our {termsAndConditions}. Please click 'Submit W9' to start the process."
