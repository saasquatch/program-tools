...
Feature: Tax And Cash Dashboard
  ...
  Scenario Outline: A Danger Alert is displayed if the users tax form is invalid
    ...
    Examples:
      ...
      | NOT_ACTIVE | W8-BEN | W8-BEN tax form is invalid. | Your tax form may have expired or has personal information that doesn’t match your profile. Please submit a new W-8 BEN-E form. |
