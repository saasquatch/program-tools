...
Feature: Tax And Cash Dashboard
  ...
  Scenario Outline: Alert displays the current state of the verification process
    ...
    Examples:
      ...
      | NEW_PAYEE_REVIEW            | yellow | N/A                                      | Your account is under review                          | This process takes 48 hours, payouts are on hold until it's completed. You will receive an email from our referral provider, Impact.com, if any issues arise.  It contains details on how to resolve this issue. If you need further assistance, please reach out to our {supportLink}.   |
      ...
      | PAYMENT_RETURNED            | yellow | Edit payout information                  | Payout unsuccessful                                   | Our recent payment attempt for your earnings was unsuccessful. Please review your payment information and make sure it is correct.                                                                                                                                                        |
