...
| `demoData`                | --                          |                                                                                       | `{ states?: { loading: boolean; disabled: boolean; formState: { formSubmission: boolean; selectedTaxForm: "w9"; errors: {}; }; }; }` | `undefined`                                                                                                                                   |
...
| `w8Description`           | `w-8-description`           | Subtext for the W8 radio button                                                       | `string`                                                                                                                             | `"W8-BEN For individuals residing outside of the US, joining the referral program of a US-based company."`                                    |
| `w8EDescription`          | `w-8-e-description`         | Subtext for the W8E radio button                                                      | `string`                                                                                                                             | `"W8-BEN-E For participants residing outside of the US who represent a business entity, joining the referral program of a US-based company."` |
...
| `w9Description`           | `w-9-description`           | Subtext for the W9 radio button                                                       | `string`                                                                                                                             | `"W9 For participants based in the US, joining the referral program of a US-based company."`                                                  |
