...
Feature: Cash payout status widget alert
  ...
  Scenario Outline: Alert displays the current state of the verification process
    ...
    Examples:
      ...
      | IDV_CHECK_REVIEW_INTERNAL   | yellow | N/A                                      | Identity verification under review                    | Identity verification requires further review due to a potential error. Our team is reviewing the information and will update you shortly. If you don't hear from us contact our support team.                                                                                            |
