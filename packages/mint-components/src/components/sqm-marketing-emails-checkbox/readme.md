...
| `checkboxName`     | `checkbox-name`     | This name is used as the key for this form field on submission. The name must be unique within this specific form. | `string`                                                                                                                                                                                                                                                        | `"marketing-emails"`                                                                   |
