        ...
        return (
          <div>
            ...
            <div class={sheet.classes.Container}>
              <span part="sqm-pretty-value">{pimpedPrettyValue + " "}</span>
              <br /> <div part="sqm-progress" class={sheet.classes.Progress} />
              <span part="sqm-subtext" class={sheet.classes.Subtext}>
                {progressBarSubtext}
              </span>
            </div>
          </div>
