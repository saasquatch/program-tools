...
| `expiryText`       | `expiry-text`       | Expiry date prefix                                                | `string` | `"Expires on "`                                                                                                                                  |
| `pendingScheduled` | `pending-scheduled` | Text describing how long a reward is pending for until it expires | `string` | `"Until"`                                                                                                                                        |
