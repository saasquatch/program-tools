...
| --------------------- | ---------------------- | ----------------------------------------------------------------------- | ------------------------------------------ | --------------------------- |
| `background`          | `background`           | Can be an image url, colour or Shoelace variable.                       | `string`                                   | `"var(--sl-color-gray-50)"` |
| `columns`             | `columns`              | Number of columns in the layout                                         | `1 \| 2`                                   | `1`                         |
| `minHeight`           | `min-height`           | Minimum height of each column including when they are stacked on mobile | `number`                                   | `undefined`                 |
