...
| `demoData`            | --                      |                                                                                                   | `{ data?: { oobCode: string; }; states?: { error: string; loading: boolean; verified: boolean; }; content?: { verifySuccessText?: string; verifyEmailText?: string; verifyInvalidText?: string; continueText?: string; }; }` | `undefined`                                                                                                      |
