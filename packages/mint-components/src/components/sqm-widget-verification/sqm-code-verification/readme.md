...
| `demoData`                   | --                              |                                                                                                                  | `{ states?: { initialiseLoading: boolean; loading: boolean; email: string; verifyFailed?: boolean; emailResent: boolean; }; refs?: { codeWrapperRef: any; }; }` | `undefined`                                                                                        |
...
| `onVerification`             | --                              |                                                                                                                  | `(token: string) => any`                                                                                                                                        | `undefined`                                                                                        |
