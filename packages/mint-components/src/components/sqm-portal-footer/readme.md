...
| `poweredByLink`   | `powered-by-link`   |             | `string`  | `"https://www.saasquatch.com/?utm_source=app&utm_medium=user-widget&utm_campaign=referral-widget"` |
...
graph TD;
  ...
  style sqm-portal-footer fill:#f9f,stroke:#333,stroke-width:4px
```
