...
| `imageAlt`        | `image-alt`        | Alt text for the hero image (columns layout). Leave empty for decorative images.                                  | `string`                                                                                                                                       | `""`           |
...
| `minHeight`       | `min-height`       | Minimum height of the component in pixels. Reserves vertical space to prevent layout shift while the image loads. | `number`                                                                                                                                       | `undefined`    |
...
graph TD;
  ...
  style sqm-hero-image fill:#f9f,stroke:#333,stroke-width:4px
```
