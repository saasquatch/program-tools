...
// builds. We use this instead of dist/components-starter.js as that is deprecated and actually doesn't work because of
...
(function(doc){
  ...
  if (!isSafari10) {
    ...
    scriptElm.src = url + '/components-starter.esm.js';
    scriptElm.setAttribute('data-stencil-namespace', 'components-starter');
  ...
  scriptElm.src = url + '/components-starter.js';
  scriptElm.setAttribute('data-stencil-namespace', 'components-starter');
  doc.head.appendChild(scriptElm)
})(document);
