...
export const ReferralListFourReferralsFirstPage = ({ linkedReferral = false, showStatus = true }) => (
  <ReferralListView
    states={{
      offset: 0,
      // @ts-ignore
...
export const ReferralListFourReferralsFirstPageHiddenStatus = ({ linkedReferral = false }) => (
  <ReferralListView
    states={{
      offset: 0,
      // @ts-ignore
