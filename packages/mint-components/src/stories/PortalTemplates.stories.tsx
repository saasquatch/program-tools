...
<sqm-router>
  <template path="/register">
    <sqm-portal-register hide-inputs="true">
<sl-input
  slot="formData"
  exportparts="label: input-label"
  type="text"
  style="margin-bottom:5px"
  name="/firstName" label="First Name"></sl-input>
<sl-input
  slot="formData"
  exportparts="label: input-label"
  type="text"
style="margin-bottom:5px"
  name="/lastName" label="Last Name"></sl-input>
<sl-input
  slot="formData"
  exportparts="label: input-label"
  type="text"
style="margin-bottom:5px"
  required
  name="/email" label="Email"></sl-input>
<sqm-password-field slot="formData"></sqm-password-field>
</sqm-portal-register>
  </template>
...
<template path="/">
    ...
    <sqm-divided-layout direction="column"
      ...
      ><sqm-portal-container
        ...
        ><sqm-titled-section label-margin="xx-small"
          ...
          ><sqm-text slot="content">
            ...
            </h1> </sqm-text></sqm-titled-section
        >
      ...
      >
        <sqm-titled-section padding="none" label-margin="x-large"
          ...
          ><sqm-text slot="content">
            <p>
              Get rewarded for referring potential customers to SaaSquatch. Earn commission for each successful lead you send our way 
            </p>
  ...
  <sqm-titled-section label-margin="small" padding="none"
          ...
          ><sqm-share-link slot="content"></sqm-share-link></sqm-titled-section
        >
        <sqm-titled-section label-margin="small" padding="none">
                    ...
                    <div class="col_cont" style="width: 100% !important">
                      ...
                      >
                        ...
                        <div
                          ...
                          "
                        >
                          <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" target="_blank" href={{validationLink}} style="height:31.5pt;width:390pt;v-text-anchor:middle;" arcsize="12%" stroke="false" fillcolor="#2b7cad"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#ffffff; font-family:Arial, sans-serif; font-size:14px"><!
                          [endif]--><a
                            href="{{validationLink}}"
                            target="_blank"
                            style="
                              ...
                              width: 100%;
                              width: calc(100% - 2px);
                              border-top: 1px solid #2b7cad;
                              border-right: 1px solid #2b7cad;
                              border-bottom: 1px solid #2b7cad;
                              border-left: 1px solid #2b7cad;
                              padding-top: 5px;
                              padding-bottom: 5px;
...
export const Portal = () => {
  return [
    ...
    <div innerHTML={portalTemplate}></div>,
  ];
};
...
export const ResetPasswordEmail = () => {
  return [
    ...
    <div innerHTML={resetPasswordTemplate}></div>,
  ];
};
...
export const VerifyEmail = () => {
  return [
    ...
    <div innerHTML={verifyEmailTemplate}></div>,
  ];
};
