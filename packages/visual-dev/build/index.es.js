...
var AttributeHeading = styled.h3(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  font-family: \"Helvetica Neue\", Helvetica, sans-serif;\n  color: #808080;\n  font-weight: normal\n  font-size: 12px;\n  line-height: 14px;\n  margin: 0px;\n  padding: 0px;\n"], ["\n  font-family: \"Helvetica Neue\", Helvetica, sans-serif;\n  color: #808080;\n  font-weight: normal\n  font-size: 12px;\n  line-height: 14px;\n  margin: 0px;\n  padding: 0px;\n"])));
var WidgetTitle = styled.h2(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  font-family: \"Helvetica Neue\", Helvetica, sans-serif;\n  color: #575757;\n  font-weight: bold;\n  font-size: 14px;\n  line-height: 16px;\n  margin: 0px;\n  padding: 0px;\n"], ["\n  font-family: \"Helvetica Neue\", Helvetica, sans-serif;\n  color: #575757;\n  font-weight: bold;\n  font-size: 14px;\n  line-height: 16px;\n  margin: 0px;\n  padding: 0px;\n"])));
...
var DetailedRadio = function (_a) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(StandardizedRadioStyles, null,
            React.createElement("input", { id: id, readOnly // since using onClick
...
var InfoWrapper = styled.div(templateObject_1$7 || (templateObject_1$7 = __makeTemplateObject(["\n  margin-bottom: 32px;\n  padding-left: 32px;\n  & * {\n    color: #999;\n  }\n  & b {\n    color: #575757;\n  }\n"], ["\n  margin-bottom: 32px;\n  padding-left: 32px;\n  & * {\n    color: #999;\n  }\n  & b {\n    color: #575757;\n  }\n"])));
var CardFormatWrapper = styled.div(templateObject_2$4 || (templateObject_2$4 = __makeTemplateObject(["\n  display: grid;\n  grid-template-columns: 49% 49%;\n  grid-column-gap: 16px;\n  grid-template-rows: repeat(auto-fill);\n  grid-row-gap: 0px;\n  grid-auto-flow: row;\n"], ["\n  display: grid;\n  grid-template-columns: 49% 49%;\n  grid-column-gap: 16px;\n  grid-template-rows: repeat(auto-fill);\n  grid-row-gap: 0px;\n  grid-auto-flow: row;\n"])));
var CardFormat = styled.div(templateObject_3$4 || (templateObject_3$4 = __makeTemplateObject(["\n  padding: 16px;\n  padding-bottom: 0;\n  background: ", ";\n  border-radius: 4px;\n"], ["\n  padding: 16px;\n  padding-bottom: 0;\n  background: ", ";\n  border-radius: 4px;\n"])), function (_a) {
    var checked = _a.checked;
    return (checked ? "#f9f9f9" : "none");
});
var RadioCards = function (props) {
    var cardFormat = props.options.cardFormat;
    var Wrapper = cardFormat ? CardFormatWrapper : Fragment;
    var Card = cardFormat ? CardFormat : Fragment;
    return (createElement(Wrapper, null, props.options.radioOptions.map(function (option) {
        var key = option.key, primaryInfo = option.primaryInfo, options = __rest(option, ["key", "primaryInfo"]);
        return (createElement(Card, { key: key, checked: props.value === key },
            createElement(DetailedRadio, __assign({ checked: props.value === key, onChange: props.onChange, id: key }, options)),
            key === "setAsPrimary" && props.value === key && primaryInfo && (createElement(InfoWrapper, null, primaryInfo.map(function (info) { return info; })))));
    })));
};
var templateObject_1$7, templateObject_2$4, templateObject_3$4;

export { AttributeHeading, H1, H2, H3, Link, LoadingSpinner, LoadingSpinnerLarge, MyComponent, P, RadioCards, Select, TextLink as TextButton, WidgetContainer, WidgetTitle };
