...
export const secondaryIconSmall = () => (
  <Button buttonType="secondary" size="small" icon="checkmark" />
);
export const secondaryIconMedium = () => (
  <Button buttonType="secondary" size="medium" icon="checkmark" />
);
export const secondaryIconLarge = () => (
  <Button buttonType="secondary" size="large" icon="checkmark" />
);

export const secondaryIconDisabledSmall = () => (
  <Button buttonType="secondary" disabled size="small" icon="checkmark" />
);
export const secondaryIconDisabledMedium = () => (
  <Button buttonType="secondary" disabled size="medium" icon="checkmark" />
);
export const secondaryIconDisabledLarge = () => (
  <Button buttonType="secondary" disabled size="large" icon="checkmark" />
);
...
// Icon
export const secondaryPillIconSmall = () => (
  <Button buttonType="secondary" pill size="small" icon="checkmark" />
);
export const secondaryPillIconMedium = () => (
  <Button buttonType="secondary" pill size="medium" icon="checkmark" />
);
export const secondaryPillIconLarge = () => (
  <Button buttonType="secondary" pill size="large" icon="checkmark" />
);

export const secondaryPillIconDisabledSmall = () => (
  <Button buttonType="secondary" pill disabled size="small" icon="checkmark" />
);
export const secondaryPillIconDisabledMedium = () => (
  <Button buttonType="secondary" pill disabled size="medium" icon="checkmark" />
);
export const secondaryPillIconDisabledLarge = () => (
  <Button buttonType="secondary" pill disabled size="large" icon="checkmark" />
);
