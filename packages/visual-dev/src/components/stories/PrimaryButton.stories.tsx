...
export const Functional = () => {
  ...
  return (
    <Button buttonType="primary" loading={states[1]} success={states[2]} onClick={() => setCount((count + 1) % 3)}>
      Primary
    </Button>
  )
}
...
export const primarySmall = () => <Button buttonType="primary" size="small">Primary</Button>
export const primaryMedium = () => <Button buttonType="primary" size="medium">Primary</Button>
export const primaryLarge = () => <Button buttonType="primary" size="large">Primary</Button>
...
// Icon
export const primaryIconSmall = () => <Button buttonType="primary" size="small" icon="checkmark" />
export const primaryIconMedium = () => <Button buttonType="primary" size="medium" icon="checkmark" />
export const primaryIconLarge = () => <Button buttonType="primary" size="large" icon="checkmark" />

export const primaryIconDisabledSmall = () => <Button buttonType="primary" disabled size="small" icon="checkmark" />
export const primaryIconDisabledMedium = () => <Button buttonType="primary" disabled size="medium" icon="checkmark" />
export const primaryIconDisabledLarge = () => <Button buttonType="primary" disabled size="large" icon="checkmark" />
...
export const primarySuccessIconSmall = () => <Button buttonType="primary" size="small" success />
export const primarySuccessIconMedium = () => <Button buttonType="primary" size="medium" success />
export const primarySuccessIconLarge = () => <Button buttonType="primary" size="large" success />

export const primaryLoadingIconSmall = () => <Button buttonType="primary" size="small" loading />
export const primaryLoadingIconMedium = () => <Button buttonType="primary" size="medium" loading />
export const primaryLoadingIconLarge = () => <Button buttonType="primary" size="large" loading />
...
// Icon
export const primaryPillIconSmall = () => <Button buttonType="primary" pill size="small" icon="checkmark" />
export const primaryPillIconMedium = () => <Button buttonType="primary" pill size="medium" icon="checkmark" />
export const primaryPillIconLarge = () => <Button buttonType="primary" pill size="large" icon="checkmark" />

export const primaryPillIconDisabledSmall = () => <Button buttonType="primary" pill disabled size="small" icon="checkmark" />
export const primaryPillIconDisabledMedium = () => <Button buttonType="primary" pill disabled size="medium" icon="checkmark" />
export const primaryPillIconDisabledLarge = () => <Button buttonType="primary" pill disabled size="large" icon="checkmark" />
...
export const primaryPillSuccessIconSmall = () => <Button buttonType="primary" pill size="small" success />
export const primaryPillSuccessIconMedium = () => <Button buttonType="primary" pill size="medium" success />
export const primaryPillSuccessIconLarge = () => <Button buttonType="primary" pill size="large" success />

export const primaryPillLoadingIconSmall = () => <Button buttonType="primary" pill size="small" loading />
export const primaryPillLoadingIconMedium = () => <Button buttonType="primary" pill size="medium" loading />
export const primaryPillLoadingIconLarge = () => <Button buttonType="primary" pill size="large" loading />
