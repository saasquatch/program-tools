...
export const criticalBadgeWithIcon = () => (
  <Badge status="critical" icon="icon-sqh-gift">
    Badge with icon
  </Badge>
);
export const warningBadge = () => <Badge status="warning">Default Badge</Badge>;
export const warningBadgeWithIcon = () => (
  <Badge status="warning" icon="icon-sqh-gift">
    Badge with icon
  </Badge>
);
export const defaultLongBadge = () => (
  <Badge status="info">A badge with a really really long name</Badge>
);
...
export const iconOnly = () => <Badge status="info" icon="icon-sqh-trash" />;
export const iconDefault = () => <Badge status="info" icon />;
