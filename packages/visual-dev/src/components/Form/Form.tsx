...
export const TextBox = React.forwardRef<React.ElementRef<"input">, InputProps>(
  (props, forwardedRef) => {
    const { ...rest } = props;
...
export const R1 = React.forwardRef<React.ElementRef<"input">, InputProps>(
  (props, forwardedRef) => {
...
export const R2 = React.forwardRef<React.ElementRef<"input">, InputProps>(
  (props, forwardedRef) => {
